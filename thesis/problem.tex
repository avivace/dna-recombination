...
\paragraph{}
In \textbf{DNA Recombination through Assembly Graph}\cite{ANGELESKA20093020}, the notion of \textit{assembly graph} is introduced TODO

\paragraph{}
The recent \textbf{Sorting by Reversals and the Theory of 4-Regular Graphs} \cite{DBLP:journals/corr/Brijder17} shows an interesting approach in describing the \textit{Reversal} evolutionary event and illustrates its correlation to the DNA recombination problem found in ciliates TODO
